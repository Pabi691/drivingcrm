...
const LearnerProfilePage = () => {
    ...
    /* ================= CALCULATIONS ================= */
    const totalPurchased = learner?.total_packages_price || 0;
        ...
        <div className="p-6 max-w-7xl mx-auto space-y-6">
            ...
            <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white dark:bg-secondary-dark-bg rounded-xl p-6 shadow">
                        <h3 className="font-semibold mb-5 text-lg">Financial Summary</h3>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <Stat label="Total Purchased" value={`£${totalPurchased.toFixed(2)}`} />
                            <Stat label="Total Paid" value={`£${totalPaid.toFixed(2)}`} />
                            <div className="p-[1px] rounded-xl bg-gradient-to-r from-red-50 to-red-100 dark:from-red-900/10 dark:to-red-800/20">
                                <Stat label="Outstanding Due" value={`£${due.toFixed(2)}`} color={due > 0 ? "#ef4444" : "#22c55e"} />
                            </div>
                        </div>
                    </div>
